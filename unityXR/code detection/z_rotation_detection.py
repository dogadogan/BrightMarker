...
while video.isOpened():
    ...
    if ret:
        ...
        # Uncomment the following 5 lines if you would like the script to send a message of "NOTHING" whenever no codes are detected
        # if not markerListCurrent:
        #     if Message != "NOTHING":
        #         Message = "NOTHING"
        ...
        for markerind, marker in enumerate(markerListCurrent):
            ...
            # Compute the endpoint of the X-axis in the marker coordinate system
            ...
            Message = str('['F"ArUco ID: {marker[0]}, Z-angle: {int(angle_degrees1)}"']')
